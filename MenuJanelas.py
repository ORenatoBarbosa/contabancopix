...
TITULO = "BEM VINDO AO SEU BANCO PIX!"\
         "Conta Bancária"

def make_win_login() -> sg.Window:
    layout_login = [
        [sg.Text("Nome: "), sg.Input(k="Nome", s=(100, 100))],
        [sg.Text("Saldo Inicial: "), sg.Input(k="SaldoIni", s=(20, 20))],
...
def make_win_menu() -> sg.Window:
    layout_menu = [
        ...
        [sg.Button("Sacar"), sg.Button("Depositar"),sg.Button("Extratos"),sg.Button("Contracheques"),sg.Button("Transferência")],
